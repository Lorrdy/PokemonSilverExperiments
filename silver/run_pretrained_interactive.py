...
if __name__ == '__main__':
    ...
    env_config = {
                ...
                'action_freq': 24, 'init_state': '../silver_quick_init.state', 'max_steps': ep_length, 
                'print_rewards': True, 'save_video': False, 'fast_video': True, 'session_path': sess_path,
                'gb_path': '../PokemonSilver.gbc', 'debug': False, 'sim_frame_dist': 2_000_000.0, 'extra_buttons': False
            }
